...
<head>
  ...
  <title>CF-Sub - 订阅转换 & SOCKS5 链式代理控制台</title>
...
<body class="theme-fluxgrid">
  ...
  <div class="site-shell">
    ...
    <header class="site-header">
      <div class="flux-container header-inner">
        <a class="brand" href="/">
          ...
          <span class="brand-text">Almighty.CF-Sub</span>
        </a>
    ...
    <footer>
      Almighty.CF-Sub &bull; YTBlog-Theme (Fluxgrid Engine) &bull; Cloudflare Workers Module Architecture
    </footer>
  </div>
